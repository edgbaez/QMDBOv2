...
namespace QMDBO
{
    class ClassWorkProcedure
    {
        ...
        public ClassWorkProcedure(DataGridView dataGridView, DataTable table, List<ParametersOracle> inParamsList, List<ParametersOracle> outParamsList, string procedureName)
        {
